...
7:                                                ; preds = %15, %2
  ...
  call void @__mypass_log_i32(i32 11, i32 %8)
...
11:                                               ; preds = %7
  ...
  call void @__mypass_log_i32(i32 15, i32 %12)
  %13 = load i32, ptr %4, align 4
  call void @__mypass_log_i32(i32 16, i32 %13)
  %14 = add nsw i32 %12, %13
  call void @__mypass_log_i32(i32 17, i32 %14)
  store i32 %14, ptr %5, align 4
  br label %15

15:                                               ; preds = %11
  %16 = load i32, ptr %6, align 4
  call void @__mypass_log_i32(i32 20, i32 %16)
  %17 = add nsw i32 %16, 1
  call void @__mypass_log_i32(i32 21, i32 %17)
  store i32 %17, ptr %6, align 4
  br label %7, !llvm.loop !6

18:                                               ; preds = %7
  %19 = load i32, ptr %5, align 4
  call void @__mypass_log_i32(i32 24, i32 %19)
  ret i32 %19
}
...
define i32 @main() #0 {
  ...
  call void @__mypass_log_i32(i32 29, i32 %3)
  store i32 %3, ptr %2, align 4
  %4 = load i32, ptr %2, align 4
  call void @__mypass_log_i32(i32 31, i32 %4)
  %5 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %4)
  call void @__mypass_log_i32(i32 32, i32 %5)
  ret i32 0
}

declare i32 @printf(ptr noundef, ...) #1

declare void @__mypass_log_i32(i32, i32)

declare void @__mypass_log_i64(i32, i64)
